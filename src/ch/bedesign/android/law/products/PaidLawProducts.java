...
public class PaidLawProducts extends BuyMeABeerProductsInitialiser implements PurchaseListener {
	...
	private void initLawProductList(Context ctx) {
		...
		lawProductsList.put("law.vstrr", getLaw(ctx, LawCodes.VSTRR, "Verwaltungsstrafrecht", "VStrR", "/313_0/"));
		lawProductsList.put("law.stpo", getLaw(ctx, LawCodes.STPO, "Strafprozessordnung", "StPO", "/312_0/"));
		lawProductsList.put("law.zpo", getLaw(ctx, LawCodes.ZPO, "Zivilprozessordnung", "ZPO", "/272/"));
		lawProductsList.put("law.urg", getLaw(ctx, LawCodes.URG, "Urheberrecht", "URG", "/231_1/"));
